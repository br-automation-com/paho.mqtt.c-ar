...
*)
	...
	IotMqttClientParType : 	STRUCT 
		ServerUri : STRING[200]; (*String containing broker's URI*)
		Port : UINT := 1883; (*TCP port number used to connect to MQTT broker*)
		ClientID : STRING[80]; (*String containing ClientID. Must be unique inside the broker*)
		UserName : STRING[80]; (*String. MQTT servers that support the MQTT v3.1 protocol provide authentication and authorisation by user name and password. This is the user name parameter*)
		Password : STRING[200]; (*String. MQTT servers that support the MQTT v3.1 protocol provide authentication and authorisation by user name and password. This is the password parameter*)
